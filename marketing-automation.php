...
<div class="breatcumb-area" style="text-align: center; padding: 50px; background-color: #f4f4f4;padding-top:10%;">
    ...
    <!-- <form action="#" method="post" style="margin: 20px 0;">
        <input type="email" name="email" placeholder="Enter your email to get notified" required 
               style="padding: 10px; font-size: 16px; width: 250px; border: 1px solid #ccc; border-radius: 5px;">
