			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
						<li><a href="#">home</a> <i class="fas fa-angle-double-right"></i> <span><a href="#">services and solution</a> <i class="fas fa-angle-double-right"></i></span> <span>Project management tool</span></li>
						</ul>
					</div>	
				</div>
			</div>
