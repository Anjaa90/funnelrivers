			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<li><a href="index.php">home</a> <i class="fas fa-angle-double-right"></i> <span><a href="#">creations</a> <i class="fas fa-angle-double-right"></i></span> <span>Website DEVELOPMENT</span></li>
						</ul>
					</div>	
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="funnelrivers-single-service-box">
							<div class="funnelrivers-sigle-tmumb">
								<img loading="lazy" src="assets\images\Creations\WebDevelopment.webp" alt="Web Development">
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="service-details-thumb">
							<img loading="lazy" src="assets\images\Creations\WebDevelopmentMini.webp" alt="Website Development">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
...
<div class="testimonial-area style-three cta">
	<div class="container text-center">
		<h1>Professional  <span style="color: #ED2C41;">Website Development</span> Services!</h1>
...
<!-- Mirrored from html.funnelriverssolution.net/funnelrivers/digital-agency/web-development.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2024 13:11:41 GMT -->
</html>
