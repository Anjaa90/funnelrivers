				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="funnelrivers-single-service-box">
							<div class="funnelrivers-sigle-tmumb">
								<img loading="lazy" src="assets\images\googleAds\GoogleAds.webp" alt="google Ads">
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="service-details-thumb">
							<img loading="lazy" src="assets\images\googleAds\GoogleAdsMini.webp" alt="google Ads">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
...
<div class="testimonial-area style-three cta">
	<div class="container text-center">
		<h1>Grow Your Business with <span style="color: #ED2C41;">Google Ads</span>!</h1>
		<a href="contact-us.php" class="cta-button">Start Your Campaign</a>
	</div>
</div>
