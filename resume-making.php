			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
						<li><a href="index.php">home</a> <i class="fas fa-angle-double-right"></i> <span><a href="#">creations</a> <i class="fas fa-angle-double-right"></i></span> <span>Resume Making</span></li>
						</ul>
					</div>	
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="dreamit-single-service-box">
							<div class="dreamit-sigle-tmumb">
								<img loading="lazy" src="assets\images\Creations\Resumemaking.webp" alt="Resume Making">
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="service-details-thumb">
							<img loading="lazy" src="assets\images\Creations\ResumeMakingMini.webp" alt="Resume Making">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
...
<div class="testimonial-area style-three cta">
	<div class="container text-center">
		<h1>Get a Professional <span style="color: #ED2C41;">Resume</span> & Land Your Dream Job!</h1>
		<a href="contact-us.php" class="cta-button">Get Your Resume Now</a>
	</div>
</div>
