				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="funnelriverss-single-service-box">
							<div class="funnelriverss-sigle-tmumb">
								<img loading="lazy" src="assets/images/Solution/ProjectManagement.webp" alt="">
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="service-details-thumb">
							<img loading="lazy" src="assets/images/Solution/ProjectManagementMini.webp" alt="">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
			...
			<div class=" col-lg-4 col-md-6 col-sm-12 col-sm-12">
				...
				<div class="widget-service-thumb-box">
					<div class="wedget-service-thumb">
						<img loading="lazy" src="assets\images/Solution/Projectmanagementtoolicon.webp"
							alt="">
...
<div class="testimonial-area style-three cta">
	<div class="container text-center">
		<h1>All-in-One <span style="color: #ED2C41;">Project Management</span> Made Simple!</h1>
