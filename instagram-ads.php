			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<li><a href="index.php">home</a> <i class="fas fa-angle-double-right"></i> <span><a href="#">Advertising</a> <i class="fas fa-angle-double-right"></i></span> <span>Instagram Ads</span></li>
						</ul>
					</div>	
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12 col-sm-12">
						<div class="funnelrivers-single-service-box">
							<div class="funnelrivers-sigle-tmumb">
								<img loading="lazy" src="assets\images\googleAds\InstaAds.webp" alt="Instagram Ads">
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="service-details-thumb">
							<img loading="lazy" src="assets\images\googleAds\InstaMini.webp" alt="Instagram Ads">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
			...
			<div class=" col-lg-4 col-md-6 col-sm-12 col-sm-12">
				...
				<div class="widget-service-thumb-box">
					<div class="wedget-service-thumb">
						<img loading="lazy" src="assets\images\googleAds\instagram-ads-370x500.png" alt="Instagram Ads">		
...
<div class="testimonial-area style-three cta">
	<div class="container text-center">
		<h1>Grow Your Business with <span style="color: #ED2C41;">Instagaram Ads</span>!</h1>
